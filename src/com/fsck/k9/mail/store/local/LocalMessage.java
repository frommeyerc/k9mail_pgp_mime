...
public class LocalMessage extends MimeMessage {
    ...
    public LocalMessage(LocalStore localStore, Account account) {
		this.localStore = localStore;
		this.account = account;
    }

    LocalMessage(LocalStore localStore, Account account, String uid, Folder folder) {
        this.localStore = localStore;
        this.account = account;
		this.mUid = uid;
        this.mFolder = folder;
    ...
    throws MessagingException {
        ...
        if (this.mFolder == null) {
            LocalFolder f = new LocalFolder(this.localStore, this.account, cursor.getInt(13));
        ...
        try {
            this.localStore.database.execute(true, new DbCallback<Void>() {
                ...
                public Void doDbWork(final SQLiteDatabase db) throws WrappedException, UnavailableStorageException {
                    ...
                    cv.put("flags", LocalStoreUtil.serializeFlags(getFlags()));
    ...
    public LocalMessage clone() {
        LocalMessage message = new LocalMessage(this.localStore, this.account);
        super.copy(message);
